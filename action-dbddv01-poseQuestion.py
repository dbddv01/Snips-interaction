...
def action_question(hermes, intentMessage):
    ...
    hermes.publish_continue_session(current_session_id, " Question : Paris est elle la capitale de la France ? ", "dbddv01:askQuestion")
    
    if intentMessage.slots.answer_capitale:
      action_reponse
